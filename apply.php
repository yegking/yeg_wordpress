...
<style>
<script>
Do.add('dialog-css', {path: 'https://img3.doubanio.com/f/accounts/7bc4ad359a2a2710a0bcdf5831dbaf99fc3cc5cf/css/ui/dialog.css', type: 'css'});
Do.add('dialog', {path: 'https://img3.doubanio.com/f/accounts/4b3bad5e25de78678d700dd5353570dce3e6bbcc/js/ui/dialog.js', type: 'js', requires: ['dialog-css']});
Do.add('validate', {path: 'https://img3.doubanio.com/f/accounts/acc10aa47ee2ad58fa7b7a63575e4ad663d073ff/js/lib/validate.js', type: 'js'});
</script>
...
<div id="header">
  <div class="site-nav single-nav">
    <div class="site-nav-logo">
      <a href="https://www.douban.com/accounts/">
  ...
  <div class="wrapper">
    <h1> 欢迎加入校跃</h1>
    <div class="main">
      <form name="" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
	   <div style="display:none;">
            <input type="hidden" name="source" value="simple"/>
            <input type="hidden" name="redir"  value="<?php echo $token; ?>" />
        </div>
	  <div class="item extra-tips">
        <label>昵　称</label>
          <label for="user_login"></label>
          <input type="text" name="name" id="name" class="basic-input" maxlength="15" tabindex="1" value="<?php if(!empty($sanitized_user_login)) echo $sanitized_user_login; ?>" />
       
        </div>
        <div class="item extra-tips">
       <label>邮　箱</label>
          <label for="user_email"></label>
          <input type="text" name="user_email" class="basic-input" id="user_email" value="<?php if(!empty($user_email)) echo $user_email; ?>" />
        
        </div>
         <div class="item extra-tips">
        <label>密　码</label>
          <input type="password" name="user_pwd1" class="basic-input" id="user_pwd1" />
        
        </div>
		<div class="item extra-tips">
        <label>重复密码</label>
          <input type="password" name="user_pwd2" class="basic-input" id="user_pwd2" />
        ...
        <div class="item">
            <label>手机号</label>
            <input id="verify_phone" name="verify_phone" type="text" class="basic-input" maxlength="60" value="" tabindex="1"/>
        </div>
...
Do('dialog', function(){
    ...
    function request_phone_code(captcha_id, captcha_solution){
        $('#tips-error em').text('')
        var i = 60, num = $.trim($("#verify_phone").val());
